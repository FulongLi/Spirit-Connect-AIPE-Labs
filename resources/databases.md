...
<header class="hero hero-compact">
  <div class="container">
    ...
    <p class="lead">
      Foundational engineering data for power electronics. These are the
...
<section class="section">
  <div class="container">
    <div class="grid grid-two">
      <a class="card post-card" href="{{ '/resources/databases/transistors/' | relative_url }}">
      ...
      <a class="card post-card" href="{{ '/resources/databases/magnetics/' | relative_url }}">
