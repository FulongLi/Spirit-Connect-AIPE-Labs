  ...
  <div class="container">
    ...
    <div class="grid grid-four">
      ...
      <div class="card">
        ...
        <p class="card-link"><a href="{{ '/resources/design-references/dab/' | relative_url }}" class="text-link">DAB design reference →</a></p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid grid-four">
      ...
      <div class="card">
        ...
        <p class="card-link"><a href="{{ '/resources/design-references/sst/' | relative_url }}" class="text-link">SST design reference →</a></p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid grid-four">
      ...
      <div class="card">
        ...
        <p>Simulation models, design references, test data, efficiency maps, loss breakdowns, BOM context, and links to the original sources.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="container">
    ...
    <div class="grid grid-two">
      <a class="card post-card" href="{{ '/resources/design-references/dab/' | relative_url }}">
      ...
      <a class="card post-card" href="{{ '/resources/design-references/sst/' | relative_url }}">
    ...
    <div class="hero-actions section-actions">
      ...
      <a class="btn btn-ghost" href="{{ '/resources/databases/transistors/' | relative_url }}">Transistor database</a>
