...
layout: default
title: Systems
permalink: /power/systems/
description: The systems domain — DC, AC and hybrid AC/DC microgrid architectures, bus choice, droop and hierarchical control, islanding and protection, and the solid-state transformer as a power router.
---
...
<header class="hero">
  <div class="container">
    ...
    <p class="lead">
      The domain above the converter: distribution architecture, system
      integration, mission profiles and validation planning. Microgrids are the
      topic covered in depth here, because islanding is what makes every other
      system-level choice consequential.
    </p>
  </div>
</header>
...
<section class="section section-alt">
  <div class="container">
    ...
    <div class="hero-actions section-actions align-left">
      ...
      <a class="btn btn-ghost" href="{{ '/resources/design-references/sst/' | relative_url }}">SST design reference</a>
