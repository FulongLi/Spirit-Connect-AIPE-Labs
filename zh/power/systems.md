...
title: 系统
lang: zh
permalink: /zh/power/systems/
description: 系统领域 —— 直流、交流与交直流混合微电网架构、母线选择、下垂与分层控制、孤岛与保护，以及作为功率路由器的固态变压器。
---
...
<header class="hero">
  <div class="container">
    <h1>电力系统</h1>
    <p class="lead">
      变换器之上的领域：配电架构、系统集成、任务工况与验证规划。
      这里重点展开的是微电网 —— 因为正是“孤岛”能力，使系统层面的其他选择都变得举足轻重。
    </p>
  </div>
</header>
...
<section class="section section-alt">
  <div class="container">
    ...
    <div class="hero-actions section-actions align-left">
      <a class="btn btn-primary" href="{{ '/zh/resources/design-references/sst/' | relative_url }}">SST 设计参考</a>
