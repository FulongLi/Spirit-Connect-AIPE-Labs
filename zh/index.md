...
<header class="hero">
  <div class="container">
    ...
    <div class="hero-actions">
      ...
      <a class="btn btn-ghost" href="{{ '/company/services/' | relative_url }}">了解 AI 智能体</a>
    </div>
  ...
  <div class="container">
    ...
    <div class="grid">
      <div class="card" style="text-align:center;">
        ...
        <a href="{{ '/power/devices/' | relative_url }}" style="display:inline-block;margin-top:1rem;font-weight:600;">了解更多 →</a>
      </div>
      <div class="card" style="text-align:center;">
        ...
        <a href="{{ '/power/converters/' | relative_url }}" style="display:inline-block;margin-top:1rem;font-weight:600;">了解更多 →</a>
      </div>
      <div class="card" style="text-align:center;">
        ...
        <p>构建微电网、直流配电网络与交直流混合电力系统，让每一台变换器
           都针对整个电网的任务需求协同优化。</p>
        <a href="{{ '/power/microgrids/' | relative_url }}" style="display:inline-block;margin-top:1rem;font-weight:600;">了解更多 →</a>
      </div>
    </div>
  </div>
</section>
