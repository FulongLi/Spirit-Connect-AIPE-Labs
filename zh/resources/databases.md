...
title: 工程数据库
lang: zh
permalink: /zh/resources/databases/
...
<section class="section">
  <div class="container">
    <div class="grid grid-two">
      <a class="card post-card" href="{{ '/zh/resources/databases/transistors/' | relative_url }}">
      ...
      <a class="card post-card" href="{{ '/zh/resources/databases/magnetics/' | relative_url }}">
